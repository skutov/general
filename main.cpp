...
public:
	...
	Hexagon::Hexagon (int newSize = 0, int newType = 0)
	{
		size = newSize;
		type = newType;
	}
...
void main ()
{
	...
	while(goAgain)
	{
		cout << endl<< "Please enter size of the hexagon: ";
		cin >> size;
		cout << endl
			 << "Please enter type of hexagon" << endl
			 << "	1: clear" << endl
			 << "	2: filled" << endl
		...
		cin >> type;
		{
			...
			newHexagon.SetSize(size);
			newHexagon.SetType(type);
		
			newHexagon.display();
		}
	
		cout << endl << endl 
			 << "Draw another hexagon?" << endl
			 << "	1: Yes" << endl
			 << "	0: No" << endl
			 << "Option: ";
		cin >> goAgain;
